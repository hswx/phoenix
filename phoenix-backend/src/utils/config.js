...
const LOCAL_SERVICE_HOST = process.env.LOCAL_SERVICE_HOST
const FILE_SERVICE_HOST = process.env.FILE_SERVICE_HOST
const ELECTRON_FRONTEND_HOST = process.env.ELECTRON_FRONTEND_HOST
const MOBILE_FRONETNE_HOST = process.env.MOBILE_FRONETNE_HOST
